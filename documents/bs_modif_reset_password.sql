...
-- Listage de la structure de table symfonyuser. reset_password_request
...
-- Listage des données de la table symfonyuser.reset_password_request : ~0 rows (environ)
...
INSERT IGNORE INTO `user` (`id`, `email`, `roles`, `password`, `is_verified`, `pseudo`, `slug`, `avatar`, `registration_date`, `last_login_date`, `author_infos`, `is_published`, `last_profil_edit_time`) VALUES
